export const menuBtn = document.getElementById('mobileMenu');
export const closeBtn = document.getElementById('closeMenu');
...
export const listItemsContainer = document.querySelector('.episodeContainer');
